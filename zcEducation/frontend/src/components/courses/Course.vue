              ...
              <div class="tab_cont" id="content">
                <div class="group_list">
                  ...
                  <div class="box">
                    ...
                    <div class="bottom">
                      <a href="{% url 'courses:course_detail' course.id %}">
                        <span class="fl">来自{{ course.orginfo.name }}</span>
                      </a>
                ...
                <div class="pageturn">
                  <ul class="pagelist">
                    ...
                    <li class="long">
                      <a
                        href="?pagenum={{ pages.previous_page_number }}&sort={{ sort }}&keyword={{ keyword }}"
                      >上一页</a>
                    </li>
                    {% endif %}
                    {% for num in pages.paginator.page_range %}
                    <li {% if num="pages.number" %}class="active" endif %}>
                      <a href="?pagenum={{ num }}&sort={{ sort }}&keyword={{ keyword }}">{{ num }}</a>
                    </li>
                    {% endfor %}
                    {% if pages.has_next %}
                    <li class="long">
                      <a
                        href="?pagenum={{ pages.next_page_number }}&sort={{ sort }}&keyword={{ keyword }}"
                      >下一页</a>
                    </li>
                    {% endif %}
                  </ul>
