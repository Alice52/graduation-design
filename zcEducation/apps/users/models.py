...
class UserProfile(AbstractUser):
    ...
    addredd = models.CharField(max_length=200, verbose_name='用户地址', null=True, blank=True)
    phone = models.CharField(max_length=11, verbose_name='用户手机号', null=True, blank=True)
...
class BannerInfo(models.Model):
    image = models.ImageField(upload_to='banner/', verbose_name='轮播图信息', max_length=200)
    url = models.URLField(default='http://baidu.com', max_length=200, verbose_name='图片导向地址')
    add_time = models.DateTimeField(verbose_name='添加时间', default=datetime.now)
