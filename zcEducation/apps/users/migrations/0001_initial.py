# -*- coding: utf-8 -*-
# Generated by Django 1.10.3 on 2019-03-24 14:01
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('addredd', models.CharField(blank=True, max_length=200, null=True, verbose_name='用户地址')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image', models.ImageField(max_length=200, upload_to='banner/', verbose_name='轮播图信息')),
                ('url', models.URLField(default='http://baidu.com', verbose_name='图片导向地址')),
                ('add_time', models.DateTimeField(default=datetime.datetime.now, verbose_name='添加时间')),
            ],
            options={
                'verbose_name': '轮播图信息',
